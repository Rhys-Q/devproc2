...
- `tools.pi05.dump_torch_oracle` 可从本地 openpi/PyTorch checkpoint dump denoise/prefix oracle，输出 `prefix_embs`、`prefix_rope_interleaved`、`prefix_k_cache`、`prefix_v_cache`、`prefix_valid_rows`、suffix `rope_interleaved`、`actions_f32` 和 torch target delta。
